    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                sendMail(user.Email, "Reciever", callbackUrl);
        ...
        public bool sendMail(string email, string name, string url)
        {
            try
            {
                var senderEmail = new MailAddress("democovrize@gmail.com", "Covrize Education");
                var receiverEmail = new MailAddress(email, name);
                var password = "democovrize123";
                var subject = "Your request for Covrize Education Password ";
